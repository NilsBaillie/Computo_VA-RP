...
[![build and publish](https://github.com/computorg/published-202512-baillie-varp/actions/workflows/build.yml/badge.svg)](https://github.com/computorg/published-202512-baillie-varp/actions/workflows/build.yml)
[![DOI:10.57750/76fh-t442](https://img.shields.io/badge/DOI-10.57750/76fh--t442-034E79.svg)](https://doi.org/10.57750/76fh-t442)
[![Creative Commons License](https://i.creativecommons.org/l/by/4.0/80x15.png)](http://creativecommons.org/licenses/by/4.0/)
[![reviews](https://img.shields.io/badge/review-report-blue.png)](https://github.com/computorg/published-202512-baillie-varp/issues?q=is%3Aopen+is%3Aissue+label%3Areview)
...
- Nils Baillie
  - Université Paris-Saclay, CEA, Service d'Études Mécaniques et Thermique
  - CMAP, CNRS, École polytechnique, Institut Polytechnique de Paris
- Antoine Van Biesbroeck
  - Université Paris-Saclay, CEA, Service d'Études Mécaniques et Thermique
  - CMAP, CNRS, École polytechnique, Institut Polytechnique de Paris
- Clément Gauchy
  - Université Paris-Saclay, CEA, Service de Génie Logiciel pour la Simulation
...
NB : We use the 2.2.0 version of the torch package.
